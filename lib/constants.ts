export const GIT_REPO = 'https://github.com/caulagi/blog'
export const AUTHOR_NAME = 'Pradip Caulagi'
export const AUTHOR_PICTURE = '/assets/blog/authors/pradip.jpg'
export const SITE_URL = 'https://blog.caulagi.com'
